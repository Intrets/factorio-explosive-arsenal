...
for name, prototype in pairs(data.raw.segment) do
    local demolisher_segment = (string.match(name, "small%-demolisher%-segment%-x0_%d+") or string.match(name, "medium%-demolisher%-segment%-x0_%d+") or string.match(name, "big%-demolisher%-segment%-x0_%d+")) ~=
        nil
